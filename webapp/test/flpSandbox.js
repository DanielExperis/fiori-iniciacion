		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#daniexamplesinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"daniexamplesinvoices-display": {
								"semanticObject": "daniexamplesinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=daniexamples.invoices",
									"url": sap.ui.require.toUrl("daniexamples/invoices")
								}
							}
						}
					}
